package com.naruto.trangopartner.login;
...
import com.naruto.trangopartner.common_files.CommonVariablesFunctions;
import com.naruto.trangopartner.main_homepage.MainHomepageActivity;
...
//            }
            ...
            case "BackToLoginCredential":
                ...
                break;
            case "MainHomePage":
                Intent intent = new Intent(LoginActivity.this, MainHomepageActivity.class);
